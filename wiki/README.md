...
[room.ts:6](https://github.com/syntela/syntela-buzz-js/blob/main/src/room.ts#L6)
...
[dashboard.ts:48](https://github.com/syntela/syntela-buzz-js/blob/main/src/dashboard.ts#L48)
...
[livestream.ts:6](https://github.com/syntela/syntela-buzz-js/blob/main/src/livestream.ts#L6)
...
[meeting.ts:7](https://github.com/syntela/syntela-buzz-js/blob/main/src/meeting.ts#L7)
...
[dashboard.ts:36](https://github.com/syntela/syntela-buzz-js/blob/main/src/dashboard.ts#L36)
...
| `domain` | `string` | The Syntela Buzz domain of the user. |
...
[widget.ts:9](https://github.com/syntela/syntela-buzz-js/blob/main/src/widget.ts#L9)
